...
input_field = Entry(input_frame, font=('arial', 18, 'bold'), textvariable=input_text, width=24, bg='#eee', bd=0, justify=RIGHT)
...
clear = Button(btns_frame, text="C", fg="black", width=32, height=3, bd=0, bg="red", cursor="hand2",
...
dot = Button(btns_frame, text='.', fg='black', width=10, height=3, bd=0, bg='#eee', cursor='hand2',
             command=lambda: btn_click('.')).grid(row=4, column=2, padx=1, pady=1)
equal = Button(btns_frame, text='=', fg='black', width=10, height=3, bd=0, bg='green', cursor='hand2',
